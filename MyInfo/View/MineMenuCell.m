...
-(void)setMenuData:(NSArray *)array
{
   ...
   ubg.frame=CGRectMake(kOriginLeft, 0, screen_width-kOriginLeft*2, count*cellHeight);
    ...
    //默认显示
    if (array==nil) {
//      NSArray * iconsArray= [NSArray arrayWithObjects: @"http://www.tutujf.com/wapassets/trust/images/news/mylogo01.png",@"http://www.tutujf.com/wapassets/trust/images/news/mylogo02.png",nil];
//       NSArray *titleArray= [NSArray arrayWithObjects: @"我要邀请",@"我要借款",nil];
        NSArray * iconsArray= [NSArray arrayWithObjects: @"http://www.tutujf.com/wapassets/trust/images/news/mylogo01.png",nil];
        NSArray *titleArray= [NSArray arrayWithObjects: @"我要邀请",nil];
