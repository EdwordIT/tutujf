//
//  MineView1Controller.m
//  TTJF
//
//  Created by 占碧光 on 2017/11/30.
//  Copyright © 2017年 占碧光. All rights reserved.
//

#import "MineView1Controller.h"
#import "JWRefresh.h"
#import "MJRefresh.h"
...
@interface MineView1Controller ()<UITableViewDataSource, UITableViewDelegate,UIScrollViewDelegate,MineNavDelegate,MineMenuDelegate,MIneMiddleDelegate,MineTopDelegate,
...
@implementation MineView1Controller
...
-(void)initData{
    ...
    array6= [NSArray arrayWithObjects: @"http://www.tutujf.com/wapassets/trust/images/news/mylogo01.png",@"http://www.tutujf.com/wapassets/trust/images/news/mylogo02.png",@"http://www.tutujf.com/wapassets/trust/images/news/mylogo04.png",@"http://www.tutujf.com/wapassets/trust/images/news/mylogo03.png",nil];
    array7= [NSArray arrayWithObjects: @"我的邀请",@"我的邀请",@"托管账户",@"银行卡管理",nil];
