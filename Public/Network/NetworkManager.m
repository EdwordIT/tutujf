...
{
    _NetworkStatus2 _current;
    _NetworkStatus2 _last;
...
- (_NetworkStatus2)reachabilityFlags:(SCNetworkReachabilityFlags)flags
{
    ...
    _NetworkStatus2 returnValue = NotReachable;
