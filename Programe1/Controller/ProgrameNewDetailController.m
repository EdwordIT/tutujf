...
//    else
    footerView = [[UIView alloc] initWithFrame:CGRectMake(0,  screen_height-kBottomButtonHeight, screen_width, kBottomButtonHeight)];
     yhx = [[UILabel alloc] initWithFrame:CGRectMake(screen_width/2-100, 17.5,200, 16)];
    yhx.font = CHINESE_SYSTEM(16);
    ...
    if(base!=nil)
        secondsCountDown = [self getDifferenceByDate:base.loan_info.open_up_date];//倒计时秒数(48小时换算成的秒数,项目中需要从服务器获取)
    ...
    yhx.text=format_time;
        footerView.backgroundColor=RGB(231,231,231);
