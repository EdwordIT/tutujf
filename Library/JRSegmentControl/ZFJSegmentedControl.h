...
typedef NS_ENUM(NSInteger, ZFJSegmentedControlType) {
    SCType_Underline,      //下划线
    SCType_Dot,            //圆点
    SCType_Ellipse,        //椭圆背景
...
@property (nonatomic,assign) ZFJButtonEdgeInsetsStyle edgeInsetsStyle;
...
//如果ZFJButtonEdgeInsetsStyle 是 ZFJButtonEdgeInsetsStyleNone 需要手动设置
