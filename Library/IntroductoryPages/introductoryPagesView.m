...
-(void)loadPageView
{
    ...
    MyPageControl *pageControl = [[MyPageControl alloc]initWithFrame:CGRectMake(MainScreen_width/2, MainScreen_height - 60, 0, 40)];
    ...
    singleRecognizer.numberOfTapsRequired = 0;
