...
// developer level errors.  This implementation simply macros to NSLog(@"%s(%d):", __func__, __LINE__);NSLog/NSAssert.
...
#ifdef DEBUG
#define _GTMDevLog(...) //NSLog(@"%s(%d):", __func__, __LINE__);NSLog(__VA_ARGS__)
#else
