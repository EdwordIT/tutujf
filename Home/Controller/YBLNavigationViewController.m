...
+ (void)initialize {
    ...
    [navigationBar setTitleTextAttributes:@{
                                            NSForegroundColorAttributeName:RGBA(40, 40, 40, 1.0),
                                            NSFontAttributeName:[UIFont systemFontOfSize:17],
                                            NSShadowAttributeName:shadow
                                            }];
   
    [navigationBar setBackgroundImage:[YBLNavigationViewController createImageWithColor:RGBA(255, 255, 255, 0.99) frame:CGRectMake(0, 0, screen_width, 64)] forBarMetrics:UIBarMetricsDefault];
